...
"[project]/src/app/api/tabs/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
async function GET() {
    // Get total tab amount per user (orders with payment_method = 'tab' and status != 'cancelled')
    // minus payments made
    const tabs = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare(`
    SELECT
      u.id as user_id,
      u.name,
      u.flat_no,
  ...
  `).all();
    const result = tabs.map((t)=>({
            ...t,
            balance: t.total_tab - t.total_paid
        }));
...
async function POST(request) {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare("INSERT INTO tab_payments (user_id, amount) VALUES (?, ?)").run(user_id, amount);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__05h0_vj._.js.map