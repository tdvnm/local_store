...
async function PATCH(request, { params }) {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare(`UPDATE products SET ${fields.join(", ")} WHERE id = ?`).run(...values);
    const product = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare("SELECT * FROM products WHERE id = ?").get(Number(id));
...
async function DELETE(request, { params }) {
    const { id } = await params;
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare("DELETE FROM products WHERE id = ?").run(Number(id));
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ok: true
    });
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0vu0yrr._.js.map